...
static t_matrix	*construct_model_translation(t_object *cylinder)
{
	t_matrix	*translation;

	translation = m_init_identity(4, 4);

	translation->m[0][3] = -cylinder->ob_coords->raw_matrix->m[0][0];
	translation->m[1][3] = -cylinder->ob_coords->raw_matrix->m[1][0];
	translation->m[2][3] = -cylinder->ob_coords->raw_matrix->m[2][0];
...
static t_matrix	*construct_model_rotation(t_object *cylinder)
{
	...
	// world_orientation = vec3_dup(cylinder->ob_cylinders->cy_vec_axis);
	world_orientation = vec3_init(cylinder->ob_cylinders->cy_vec_axis->raw_matrix->m[0][0], 
									cylinder->ob_cylinders->cy_vec_axis->raw_matrix->m[1][0], 
									cylinder->ob_cylinders->cy_vec_axis->raw_matrix->m[2][0]);
...
static t_matrix	*construct_model_rotation_2(t_cylinder *cylinder)
{
	...
	model_orientation = vec3_init(0, 0, 1);
	world_orientation = vec3_init(cylinder->cy_vec_axis->raw_matrix->m[0][0], 
									cylinder->cy_vec_axis->raw_matrix->m[1][0], 
									cylinder->cy_vec_axis->raw_matrix->m[2][0]);
...
t_matrix	*get_model_matrix(t_object *cylinder)
{
	t_matrix	*translation;
	t_matrix	*rotation;
	t_matrix	*res;
