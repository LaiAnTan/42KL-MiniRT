...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/05 18:00:31 by tlai-an           #+#    #+#             */
/*   Updated: 2023/09/05 18:33:21 by tlai-an          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// orr_matrix for orientation vectors
// 4x4 view_matrix for points (world->view coords)
...
typedef double	(*t_object_runner) (t_ray *, t_object *);
...
t_matrix	*construct_rotation(t_vec3 *right, t_vec3 *true_up,
				t_vec3 *forward);
